...
export const Stats = () => {
  return (
    <div className="statsContainer">
      <motion.div whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 2 }} initial={{ x: -300, opacity: 0 }} className="statsLeft">
        <img className="statsImg" src={imgsl} />
      </motion.div>

      <motion.div whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 2 }} initial={{ x: 300, opacity: 0 }} className="statsRight">
